...
**Ưu tiên cần help:**
- Test & fix cho X (Twitter), LinkedIn, Reddit, Threads
- Cải thiện prompt templates
- Thêm ngôn ngữ mới cho "Xem thêm" detection
- Bug reports

**Quy tắc:**
- Giữ zero dependencies — không thêm npm package
- Code style: vanilla JS, không framework
